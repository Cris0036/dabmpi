...
from sympy import symbols, cos, sin, sqrt, lambdify
import numpy as np
import mpmath
...
class ProblemCristina(object):
    def __init__(self, n_dimensions=4):
        ...
        self.r_values = [0.2, 0.04081633, 0.08163265, 0.12244898, 0.16326531,
        ...
        # Al no depender el integrando de phi, se nos quedaria 2pi * (integral de 0 a 2pi
    ...
    def solve(self, solution):
        ...
        for i in range(len(params)): 
            ...
            # Evaluamo los valores de r y q y preparamos para la integracion
            integrando_mp = lambda theta: self.integrando_func(theta, r_val, q_val)
            integral = mpmath.quad(integrando_mp, [0, 2*mpmath.pi])
            
            # Actualizamos el sumatorio
            val += integral
            print(integral)
